...
grid on
legend('Q=0.01*I_2','Q=1*I_2','Q=10*I_2','Q=1000*I_2','i\_ref', 'Location','northeast')
xlabel("Time [s]")
ylabel("Current [A]")
...
grid on
legend('Q=0.01*I_2','Q=1*I_2','Q=10*I_2','Q=1000*I_2','n\_ref', 'Location','southeast')
xlabel("Time [s]")
...
xlabel("Time [s]")
ylabel("Velocity [rad/s]")
legend('Q=0.01*I_2','Q=1*I_2','Q=10*I_2','Q=1000*I_2','n\_ref', 'Location','northeast')
grid on
...
yline(yref(2), 'Color', 'red', 'LineStyle','--', 'LineWidth', 1.5)
grid on
legend('n_{LQR}','n_{MPC}','n\_ref', 'Location','southeast')
ylim([69 105]);
xlabel("Time [s]")
ylabel("Velocity [rad/s]")
...
yline(yref(1), 'Color', 'red', 'LineStyle','--', 'LineWidth', 1.5)
grid on
legend('Q=0.001*I_2','Q=1*I_2','Q=1000*I_2', 'Location','northeast')
xlabel("Time [s]")
ylabel("Current [A]")
...
grid on
ylim([69 105])
legend('Q=0.001*I_2','Q=1*I_2','Q=1000*I_2', 'Location','southeast')
xlabel("Time [s]")
ylabel("Velocity [rad/s]")
